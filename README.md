...
* **`10월 - 11월`** 🎙️ **SilverLink - AI 복지 도우미** (경북대 AI-conic 해커톤 최우수상/2등)
...
> **의료진용 실시간 트리아지 및 환자용 의료기록 번역 듀얼 에이전트 시스템** (2026.01 - 2026.02)
- **주요 성과**:
...
> **국제 수학 올림피아드(IMO) 수준의 복잡한 주관식 문제를 해결하는 자율 AI 시스템** (2025.11 - 2026.02)
- **주요 성과**:
...
> **정형 데이터 기반의 심장 질환 발생 여부 예측 이진 분류 모델** (2026.01 - 2026.02)
- **주요 성과**:
...
> **유전체 서열 데이터 분석을 통한 변이 여부 감지 딥러닝 모델** (2025.11 - 2025.12)
- **주요 성과**:
  - 단독 참여로 **최종 101위** 기록.
...
> **AGI 추론 벤치마크 달성을 위한 추상적 시각 패턴 인식 모델** (2025.09 - 2025.11)
- **주요 성과**:
...
> **사용자 피처 및 광고 데이터를 활용한 클릭률(CTR) 예측 ML 모델** (2025.09 - 2025.10)
- **주요 성과**:
...
> **센서 데이터를 분석하여 해양 이상 상태를 감지하는 분류 모델** (2025.09 - 2025.10)
- **주요 성과**:
...
> **텍스트 카테고리 고속 자동 분류 모델** (2025.08 - 2025.09)
- **주요 성과**:
